...
const Card = ({ item }) => {
  console.log(item);
  return (
    <div className="border p-6 border-gray-200 text-black shadow-md hover:shadow-lg rounded-2xl bg-linear-to-br from-white to-gray-50 transition-all duration-300 hover:scale-105 hover:-translate-y-1 group">
