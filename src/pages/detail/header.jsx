...
const Header = () => {
  ...
  return (
    <div className="flex items-center justify-between">
      <Link
        to="/"
        className="bg-linear-to-r from-gray-600 to-gray-700 flex items-center gap-2 text-white p-3 pe-3 rounded-xl hover:from-gray-700 hover:to-gray-800 shadow-md hover:shadow-lg transition-all duration-300 font-medium group"
      >
